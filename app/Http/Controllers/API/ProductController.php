...
class ProductController extends Controller
{
    ...
    {
        // $id = $request->input('id'); panggil berdasarkan id 
        // $limit = $request->input('limit', 6); membatasi data yang di ambil
        // $name = $request->input('name'); mencari berdasarkan nama
